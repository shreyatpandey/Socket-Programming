a.Name:- Shreyat Pandey
b.Student ID:-9885890882
...
2.serverA:- The serverA is up and running using UDP on port<21882>
           ...
           The server A finished sending the output to AWS
3.serverB:- The Server B is up and running using UDP on port <22882>
...
4.serverC:- The Server C is up and running using UDP on port <23882>
...
f.Any idiosyncrasy of the project:-
